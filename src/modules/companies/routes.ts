...
const companiesRoutes: FastifyPluginAsync = async (app) => {
  ...
  const updateCompanySchema = z.object({
    ...
    businessId: z.string().max(32).nullable().optional(),
    legalForm: z.string().max(64).nullable().optional(),
    managingDirectors: z.string().max(200).nullable().optional(),
    chamber: z.string().max(200).nullable().optional(),
